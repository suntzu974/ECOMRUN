 ...
 */
@WebServlet("/stocks")
public class StockIngresByGencod extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		QueryStock query = new QueryStock();
		ResponseStock list = null;
		query = gson.fromJson(tools.decodeRequest(request), QueryStock.class);
		System.out.println(request);
		System.out.println(query);
   		try {
   			list = dbquery.queryStockIngresByGencod(ingres,query);
