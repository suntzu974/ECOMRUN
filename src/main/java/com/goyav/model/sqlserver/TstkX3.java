...
public class TstkX3 {
	...
	public TstkX3(short i1ent, String chcodi, short i1depot, String codex3, double f8qtestk, double f8qteres,
			double f8qtenl, double f8stkalert, long didatrupt, long didatalert, long didatdent, long didatdsor,
			long didatdinv, String vcempl) {
		super();
		this.i1ent = i1ent;
		this.chcodi = chcodi;
